import { translate, type MessageKey } from '../content/language';
...
export const World=forwardRef<WorldHandle,{state:RendererState;callbacks:RendererCallbacks}>(function World({state,callbacks},ref){
 ...
 return <svg ref={svg} className='world-svg' role='group' aria-label={t("SVG 입체 항해 지도. 장소를 선택하거나 드래그하여 이동. 확대와 시점 회전 버튼으로 조작.")} tabIndex={0}/>;
});
